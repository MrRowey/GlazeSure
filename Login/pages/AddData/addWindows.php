...
if (!isset($_POST['TypeName'])) {
  ...
  $sql = "INSERT INTO windows (TypeName) VALUES ('$TypeName')";
...
$sql = "SELECT ID, TypeName FROM windows";
$result = mysqli_query($conn, $sql);
?>

<html>
<head>
    <title>Add Window Type</title>
    <meta charset="utf-8">
...
<main class="w3-container">  
  <h1 class="display-2">Add New Window Type</h1>
  <form class="w3-container" action="addWindows.php" method="POST">
    <label class="w3-text-blue"><b>Add Type</b></label>
      <input class="w3-input w3-border" type="text" name="TypeName" id="TypeName" required><br>
